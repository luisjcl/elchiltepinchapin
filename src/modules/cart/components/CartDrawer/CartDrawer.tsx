        ...
        <SheetFooter>
          {fields && currentStep === "details" ? (
            <div className="flex w-full flex-col gap-4">
              ...
              <Button
  className="w-full m-auto px-4 shadow-lg bg-red-700 text-white hover:bg-red-900"
          ...
          {(currentStep === "fields" || !fields) && (
            <div className="flex w-full flex-col gap-4">
              ...
              <a
                ...
                target="_blank"
              >
                <Button className="w-full m-auto px-4 shadow-lg bg-red-700 text-white hover:bg-red-900" data-testid="complete-order" size="lg" variant="brand">
